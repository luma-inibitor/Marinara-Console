...
export function Hash() {
  return (
    ...
    >
      <CopyableText value="source_character_c7a1843d96ae1092" label="source id" />
      <div style={{ marginTop: "var(--s2)" }}>
        <CopyableText value="9f2c1ad4e37b58c0a61d4f8e2b93760c5d1e8a47f0b2c96d3e75a18b4c0f2d69" label="content hash" />
      </div>
    </div>
  );
}
