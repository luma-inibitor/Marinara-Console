...
const ATLAS: Entry[] = [
  ...
  entry({
    ...
    keys: ["bell", "tide bell"],
    content:
      "Rung twice for a returning boat, three times for a wreck. Nobody has rung it three times in eleven years.",
  }),
  entry({
    id: "e-market",
    name: "Fishmarket",
...
const CAST: Entry[] = [
  entry({
    ...
    tag: "principals",
    keys: ["mira"],
    content: "See the Atlas entry; this book carries her voice, not her post.",
  }),
  entry({
    id: "c-tolley",
    name: "Tolley",
    tag: "principals",
    keys: ["tolley"],
    content: "Speaks in half sentences and finishes none of them near the water.",
  }),
  entry({
    id: "c-clerk",
    name: "The clerk",
    tag: "walk-ons",
    keys: ["clerk"],
    content: "Unnamed on purpose. Whoever is holding the ledger that day.",
  }),
  ...
  entry({
    ...
    tag: "walk-ons",
    keys: ["dockers"],
    content: "Six voices, no names, one opinion.",
  }),
  entry({
    id: "c-narr",
    name: "Narration",
    tag: "",
    constant: true,
    content: "Third person, past tense, no interiority for anyone but the player character.",
  }),
];
...
const RULES: Entry[] = [
  entry({
    ...
    tag: "",
    constant: true,
    content: "No harm to the ferry children. Storms are never a punishment.",
  }),
  entry({
    id: "r-length",
    name: "Length",
    tag: "",
    constant: true,
    content: "Two to four paragraphs. End on something the player can act on.",
  }),
  entry({
    id: "r-names",
    name: "Names",
    tag: "",
    keys: ["name", "called"],
    content: "Coin names from the tide boards: Ashe, Vance, Tolley, Merrow.",
  }),
  entry({
    id: "r-dice",
    name: "Dice",
